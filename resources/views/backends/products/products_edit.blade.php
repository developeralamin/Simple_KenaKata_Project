...
<section class="content">
	 ...
	 <form method="post" action="{{ route('Product.update',$edit->id) }}" 
	...
	<div class="row">
		...
		<div class="col-md-4" >		
			...
			<div class="controls">
				 <input type="text" name="cost_price" value="{{ $edit->cost_price }}"  class="form-control" >  
			</div>
		...
		<div class="col-md-4" >		
			...
			<div class="controls">
				 <input type="text" name="sale_price"   value="{{ $edit->sale_price }}" class="form-control"  >  
			</div>
		...
		<div class="col-md-4" >		
			...
			<select name="stock" id="stock"  value="{{ old('stock') }}"  class="form-control">
				<option value="YES" {{ ($edit->stock == "YES" ? "selected": "") }}>YES</option>
				<option value="NO" {{ ($edit->stock == "NO" ? "selected": "") }}>NO</option>
			</select>  
			</div>
  ...
  {{-- end this section --}}
    ...
    <div class="controls">
        ...
        src="{{url('uploads/product/'.$edit->image) ??'' }}" style="width: 300px;height: 300px;border: 1px solid #000000" alt="User Avatar"> 
