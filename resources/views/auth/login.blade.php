...
<head>
  <meta charset="utf-8">
    ...
    <title>কেনাকাটা Dokan - Log in </title>
...
<div class="col-lg-4 col-md-5 col-12">
    <div class="content-top-agile p-10">
        <h3 class="text-white"> নিজের দোকানের ড্যাশবোর্ড এ প্রবেশ করুন   </h3>
...
<div class="form-group">
  ...
  <div class="row">
    ...
    <div class="col-12 text-center">
      <button type="submit" class="btn btn-info btn-rounded mt-10">ক্লিক করুন </button>
    </div>
    <!-- /.col -->
  </div>
</form>                                                     
        ...
        <div class="text-center">
            <p class="mt-15 mb-0 text-white">অ্যাকাউন্ট না থাকলে ? 
                <a href="{{ route('register') }}" class="btn btn-info btn-rounded mt-10" 
                style="color:#ffffff!important"> অ্যাকাউন্ট করুন </a>
            </p>
        </div>
    </div>
</div>
